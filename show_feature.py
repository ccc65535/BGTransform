...
for type in aug_names:
    ...
    sub_fig.set_ylabel('Amplitude($\mu$V)',rotation=90)
    sub_fig.yaxis.set_label_coords(-0.1, 0.5)
    sub_fig.set_title('Raw\nSample',x=-.35,y=.3)
    ...
    sub_fig.set_ylabel('Amplitude($\mu$V)',rotation=90)
    sub_fig.yaxis.set_label_coords(-0.08, 0.5)
    ...
    sub_fig.set_ylabel('Amplitude($\mu$V)',rotation=90)
    sub_fig.yaxis.set_label_coords(-0.1, 0.5)
    sub_fig.set_title('Bg_T',x=-.3,y=.3)
    ...
    plt.subplots_adjust(top=0.98,bottom=0.1,left=0.18,right=0.95,hspace=0.5,wspace=0.2)
