...
for duration in durations:
    ...
    for fold,(train_ind,test_ind) in enumerate( kf.split(trials)):
        ...
        save_path='./model_save/nak-eegnet-fold-'+str(fold)+'-'+str(duration)+'s.pth'
        ...
        for sub_id in range(nsubject):
            ...
            aug_X,aug_y=bgt.generate_data(sub_trainX.numpy(),sub_trainY,'FrequencyShift',nt=[2 for i in range(int(ex))]+[3 for i in range(ex)])
