...
res_file_name='./record/P3-eegnet-'+aug_names[0]+'-'+aug_names[1]+'-'+str(ex*4)+'times.xlsx'
res_file=pd.ExcelWriter(res_file_name)

res_file_name2='./record/P3-eegnet-f1-'+aug_names[0]+'-'+aug_names[1]+'-'+str(ex*4)+'times.xlsx'
