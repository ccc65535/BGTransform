...
ex=8
res_file_name='./record/bench-deep-'+aug_names[0]+'-'+aug_names[1]+'-'+str(ex*4)+'times.xlsx'
...
for duration in durations:
    ...
    for fold,(train_ind,test_ind) in enumerate( kf.split(trials)):
        ...
        all_model_save_path='./model_save/deep-fold-'+str(fold)+'-'+str(duration)+'s-bench.pth'
        ...
        if first_train==True:
            ...
            batch_size,max_epochs,lr = 128,600,5e-3
        ...
        for sub_id in subjects:
            ...
            max_acc=0
            min_loss=np.inf
            save_path='./model_save/bench-deep-bgt-'+str(duration)+'s-fold-'+str(fold)+'-sub-'+str(sub_id)+'.pth'
