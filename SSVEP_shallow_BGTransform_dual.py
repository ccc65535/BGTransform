...
ex=8
res_file_name='./record/bench-shallow-'+aug_names[0]+'-'+aug_names[1]+'-'+str(ex*4)+'times.xlsx'
...
for duration in durations:
    ...
    for fold,(train_ind,test_ind) in enumerate( kf.split(trials)):
        ...
        all_model_save_path='./model_save/shallow-fold-'+str(fold)+'-'+str(duration)+'s-bench.pth'
        ...
        for sub_id in subjects:
            ...
            max_acc=0
            min_loss=np.inf
            save_path='./model_save/bench-shallow-bgt-'+str(duration)+'s-fold-'+str(fold)+'-sub-'+str(sub_id)+'.pth'
