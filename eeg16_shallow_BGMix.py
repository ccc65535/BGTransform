...
res_file_name='./record/eeg16-shallow-'+aug_names[0]+'-'+aug_names[1]+'-'+str(ex*4)+'times.xlsx'
...
for duration in durations:
    ...
    for fold in trials:
        ...
        save_path='./model_save/shallow-fold-'+str(fold)+'-'+str(duration)+'s-eeg16.pth'
        tunning=True
        new_test=True
        # new_test = False
        if tunning:
        ...
        # for sub_id in [2,9,10]:
            ...
            max_acc=0
            min_loss=np.inf
            save_path='./model_save/eeg16-shallow-'+str(duration)+'s-fold-'+str(fold)+'-sub-'+str(sub_id)+'.pth'
