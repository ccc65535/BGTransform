...
res_file_name='./record/P3-deep-'+aug_names[0]+'-'+aug_names[1]+'-'+str(ex*4)+'times.xlsx'
res_file=pd.ExcelWriter(res_file_name)

res_file_name2='./record/P3-deep-f1-'+aug_names[0]+'-'+aug_names[1]+'-'+str(ex*4)+'times.xlsx'
...
for k in range(kfold):
    ...
    all_model_save_path='./model_save/deep-fold-'+str(k)+'-'+str(duration)+'s-P3.pth'
    ...
    for sub_id in subjects:
        ...
        max_acc=0
        min_loss=np.inf
        save_path='./model_save/p3-deep-'+str(duration)+'s-fold-'+str(k)+'-sub-'+str(sub_id)+'.pth'
