...
for aug_name in aug_names:
    ...
    for i,ex in enumerate([1,2,4,8,16]):
            ...
            res_file_name='./record/nak-eegnet-'+aug_name+'-'+str(ex*2)+'times.xlsx'
            res_file=pd.ExcelWriter(res_file_name)
            for duration in durations:
                ...
                for fold,(train_ind,test_ind) in enumerate( kf.split(trials)):
                    ...
                    for sub_id in range(nsubject):
                        ...
                        aug_X,aug_y=bgt.generate_data(sub_trainX.numpy(),sub_trainY,aug_name,nt=[2 for i in range(int(ex))]+[3 for i in range(ex)])
