...
# aug_names=['TimeReverse','SmoothTimeMask']
# aug_names=['FrequencyShift','FTSurrogate']
# aug_names=['TimeReverse','FTSurrogate']

first_train=True

ex=8
res_file_name='./record/bench-ssveptf.xlsx'
...
for duration in durations:
    ...
    for fold,(train_ind,test_ind) in enumerate( kf.split(trials)):
        ...
        all_model_save_path='./model_save/ssveptf-fold-'+str(fold)+'-'+str(duration)+'s-bench.pth'
        ...
        if first_train==True:
            ...
            save_path='./model_save/bench-ssveptf-fold-'+str(fold)+'-'+str(duration)+'s.pth'
        ...
        for sub_id in subjects:
            ...
            max_acc=0
            min_loss=np.inf
            save_path='./model_save/bench-ssveptf-'+str(duration)+'s-fold-'+str(fold)+'-sub-'+str(sub_id)+'.pth'
