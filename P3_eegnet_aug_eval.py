...
for aug_name in aug_names:
    ...
    for j,ex in enumerate([2,4,8,16,32]):
        if j!=0:
            first_train=False

        res_file_name='./record/aug/P3-eegnet-'+aug_name+'-'+str(ex)+'times.xlsx'
        res_file=pd.ExcelWriter(res_file_name)

        res_file_name2='./record/aug/P3-eegnet-f1-'+aug_name+'-'+str(ex)+'times.xlsx'
        ...
        for k in range(kfold):
            ...
            for sub_id in subjects:
                ...
                aug_X,aug_y=Augmentation.augment(aug_name,ex,sub_trainX,sub_trainY,srate)
