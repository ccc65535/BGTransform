...
ex=8
res_file_name='./record/bench-ssvepnet-BGTransform.xlsx'
...
for duration in durations:
    ...
    for fold,(train_ind,test_ind) in enumerate( kf.split(trials)):
        ...
        all_model_save_path='./model_save/ssvepnet-fold-'+str(fold)+'-'+str(duration)+'s-bench.pth'
        ...
        ######
        batch_size,max_epochs,lr,wd = 100,500,1e-3,0.0003
        ...
        for sub_id in subjects:
            ...
            max_acc=0
            min_loss=np.inf
            save_path='./model_save/bench-ssvepnet-bgt-'+str(duration)+'s-fold-'+str(fold)+'-sub-'+str(sub_id)+'.pth'
